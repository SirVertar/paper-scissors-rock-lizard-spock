...
class GameController {
    ...
    void startGame(GameRule gameRule) {
        if (gameRule instanceof RpslsGameRule) {
            do {
                ...
                switch (firstPlayerChoice) {
                    ...
                    case 3:
                    case 4:
                        RpslsCheckSecondPlayerChoice(secondPlayerChoice, gameRule);
                        break;
                    case 5:
                        printGoodbye();
                        exit = true;
    ...
    private void RpslsCheckSecondPlayerChoice(int choice, GameRule gameRule) {
